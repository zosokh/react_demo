...
<head>
    ...
    <link rel="apple-touch-icon" href="/react_demo/apple-touch-icon.png"/>
    <link rel="shortcut icon" href="/react_demo/favicon.ico?{appinfo version}"/>
    <!-- <meta charset="utf-8"> -->
    ...
    <link rel="stylesheet" href="/react_demo/css/main.css" type="text/css" media="all">
